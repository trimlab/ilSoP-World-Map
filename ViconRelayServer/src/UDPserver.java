...
class MessageHandler implements Runnable 
{
	...
	public void run() {
		...
		vecCountries.add(new CountryLocation(1.4f, 2.3f,  1.3f, -1, .05f , "MTU_Introduction_English_Female.wav"));
		vecCountries.add(new CountryLocation(1.4f, 2.3f, 1.3f, 1 ,.05f, "MTU_Introduction_English_Male.wav"));
		...
		vecCountries.add(new CountryLocation(-2.0f, 2.5f, 1.8f, -1, .1f,"MTU_Intro_Farc.wav"));
		vecCountries.add(new CountryLocation(-2.0f, 2.5f, 1.8f, 1, .1f,"MTU_Intro_Farc.wav"));
                vecCountries.add(new CountryLocation(.8f, 2.5f, 1.9f, -1, .05f,"MTU_Introduction_Alien_Female.wav"));
		vecCountries.add(new CountryLocation(.8f, 2.5f, 1.9f, 1, .05f,"MTU_Introduction_Alien_Male.wav"));
		...
		while (UDPserver.keepRunning) {
            try {
	            ...
	            if (parts.length >= 9){
	                ...
	                CONSTANTS.DebugPrint("Coords : "+x+", "+y+", "+", "+z+", "+spin, 50);
